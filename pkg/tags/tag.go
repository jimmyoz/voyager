...
const (
	...
	StateSplit               // chunk has voyagern processed by filehasher/infinity safe call
...
type Tag struct {
	...
	Address   infinity.Address // the associated infinity hash for this tag
...
// DoneSplit sets total count to SPLIT count and sets the associated infinity hash for this tag
