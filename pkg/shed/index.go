...
// Item holds fields relevant to Infinity Chunk data and metadata.
// All information required for infinity storage and operations
// on that storage must be defined here.
// This structure is logically connected to infinity storage,
