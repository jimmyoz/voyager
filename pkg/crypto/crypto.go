...
// NewOverlayAddress constructs a Infinity Address from ECDSA public key.
...
// NewOverlayFromEthereumAddress constructs a Infinity Address for an Ethereum address.
